    ...
    <BasePage :title="$t('shellyadmin.ShellySettings')" :isLoading="dataLoading">
        ...
        <form @submit="saveShellyConfig">
            <CardElement :text="$t('shellyadmin.ShellyGet')" textVariant="text-bg-primary">
                <InputElement
                    :label="$t('shellyadmin.ShellyGetSwitch')"
                    v-model="shellyConfigList.shelly_enable"
                    type="checkbox"
                />

                <InputElement
                    :label="$t('shellyadmin.ShellyPro3em')"
                    v-model="shellyConfigList.shelly_hostname_pro3em"
                    type="text"
                    maxlength="128"
                    :placeholder="$t('shellyadmin.HostnameHint')"
                    v-show="shellyConfigList.shelly_enable"
                />

                <InputElement
                    :label="$t('shellyadmin.ShellyPlugS')"
                    v-model="shellyConfigList.shelly_hostname_plugs"
                    type="text"
                    maxlength="128"
                    :placeholder="$t('shellyadmin.HostnameHint')"
                    v-show="shellyConfigList.shelly_enable"
            ...
            <CardElement
                :text="$t('shellyadmin.ShellySet')"
                textVariant="text-bg-primary"
                add-space
                v-show="shellyConfigList.shelly_enable"
            >
                <InputElement
                    :label="$t('shellyadmin.ShellySetSwitch')"
                    v-model="shellyConfigList.limit_enable"
                    type="checkbox"
                    v-show="shellyConfigList.shelly_enable"
                />

                <InputElement
                    :label="$t('shellyadmin.MaxPower')"
                    v-model="shellyConfigList.max_power"
                    type="number"
                    min="1"
                    max="3000"
                    :placeholder="$t('shellyadmin.MaxPowerHint')"
                    v-show="shellyConfigList.shelly_enable && shellyConfigList.limit_enable"
                />

                <InputElement
                    :label="$t('shellyadmin.MinPower')"
                    v-model="shellyConfigList.min_power"
                    type="number"
                    min="0"
                    max="500"
                    :placeholder="$t('shellyadmin.MinPowerHint')"
                    v-show="shellyConfigList.shelly_enable && shellyConfigList.limit_enable"
                />

                <InputElement
                    :label="$t('shellyadmin.TargetValue')"
                    v-model="shellyConfigList.target_value"
                    type="number"
                    min="-100"
                    max="300"
                    :placeholder="$t('shellyadmin.TargetValueHint')"
                    v-show="shellyConfigList.shelly_enable && shellyConfigList.limit_enable"
                />
                    ...
                    <div class="col-sm-10">
                        <div class="input-group mb-3">
                            <input
                                ...
                                v-model="shellyConfigList.feed_in_level"
                                min="0"
                                max="100"
                                id="inputFeedInLevel"
