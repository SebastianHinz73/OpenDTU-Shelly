...
#define SHELLY_ENABLE false
#define SHELLY_MOREINFO_ENABLE false
#define SHELLY_LIMIT_ENABLE false
#define SHELLY_MAX_POWER 300U
#define SHELLY_MIN_POWER 0
#define SHELLY_LIMIT_POWER 300U
#define SHELLY_HOST ""
#define SHELLY_TARGET_VALUE 0
#define SHELLY_DEBUG_ENABLE false
#define SHELLY_FEED_IN_LEVEL 0U
